...
const OrdemServicoList = () => import("@/components/pages/ordemServico/List");
const OrdemServicoEdit = () => import("@/components/pages/ordemServico/Edit");
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'ordemServico/editar/:codigo',
                name: 'OrdensServicoEdit',
                component: OrdemServicoEdit,
                meta: {
                    label: "Ordem de Serviço"
                },
