        ...
        <div class="row form-group align-items-end mt-5">
            ...
            <div class="col-8">
                <div class="text-right">
                    ...
                    <input type="submit" value="Salvar" class="btn btn-success" @click.prevent="Pagar()" :class="{'disabled': isSubmiting}">
                </div>
            </div>
        </div>
    </div>
    ...
    created() {
        if (this.conta) {
            ...
            ContasPagarService.getParcela(this.conta).then(function (response) {
                ...
                vm.formaSelecionada = vm.entity.formPagamento.descricao;
            });
        } else {
